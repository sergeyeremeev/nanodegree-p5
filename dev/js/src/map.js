...
// execute when the google maps callback indicates that the map has loaded successfully
...
var App = (function() {
    ...
    // return AppViewModel, so it can be used outside the IIFE
    return AppViewModel;
}());

// apply ko bindings via callback when google map has loaded successfully
function initMap() {
